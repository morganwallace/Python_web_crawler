...
def Relative_URL_Checker(url,originator_url):
    if url[0] == '/':
        ...
        origParsed = urllib.parse.urlparse(originator_url)
...
# 	crawl() #remove comment to have script crawl the ischool.berkeley.edu site 
	...
	webPageDataDict=loadData(webPageDataDict,'webPageDataDictFile.p')
	makeInverseIndex()
